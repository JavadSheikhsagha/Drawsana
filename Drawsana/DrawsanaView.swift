...
public protocol DrawsanaViewDelegate: AnyObject {
    ...
    func drawsanaView(_ drawsanaView: DrawsanaView, didMoveDrag drag: Set<UITouch>, event : UIEvent?)
    func drawsanaView(_ drawsanaView: DrawsanaView, gestureRecog : UIGestureRecognizer)
    func drawsanaView(_ drawsanaView: DrawsanaView, didStartDrag tool: UIGestureRecognizer)
}
...
public class DrawsanaView: UIView {
    ...
    public let drawingContentView = UIView()
    ...
    private func _didPan(sender: ImmediatePanGestureRecognizer) {
        ...
        delegate?.drawsanaView(self, gestureRecog: sender as! UIGestureRecognizer)
        ...
        case .began:
            ...
            delegate?.drawsanaView(self, didStartDrag: sender as! UIGestureRecognizer)
    ...
    public override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?) {
        delegate?.drawsanaView(self, didMoveDrag: touches, event: event)
    }
